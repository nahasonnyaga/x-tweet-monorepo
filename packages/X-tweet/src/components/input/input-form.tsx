        ...
        <div className="flex flex-col gap-3">
          ...
          {isUploadingImages && (
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 rounded-2xl overflow-hidden">
              {/* Example placeholder until actual image preview is implemented */}
              <div className="relative w-full h-48 sm:h-56 rounded-2xl overflow-hidden bg-light-secondary/20 dark:bg-dark-secondary/20">
                <Image
