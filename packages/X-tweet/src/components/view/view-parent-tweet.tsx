...
export function ViewParentTweet({
  ...
  if (!data)
    return (
      <div className="px-4 pt-3 pb-2">
        <p className="rounded-2xl bg-main-sidebar-background py-3 px-1 pl-4 text-light-secondary dark:text-dark-secondary">
  ...
  return <TweetComponent parentTweet {...data} />; // ✅ updated usage
}
